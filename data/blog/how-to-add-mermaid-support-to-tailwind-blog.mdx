...
That's the neat part, because it's pretty brainless. Just execute:
...
Mermaid just process everything that it's under a CSS class `mermaid`, so basically this component just
initialize mermaid and creates a div with a CSS class `mermaid`, in which the mermaid syntax is placed. Easy.
...
Now you are able to render Mermaid charts in your MDX! Is as easy as this:
