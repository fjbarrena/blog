---
title: "Cloud Security: Can't someone else DO it?"
date: '2019-10-11'
tags: ['cybersecurity', 'cloud', 'shared responsibility']
draft: false
summary: 'Many companies believe their cloud provider offers sufficient protection against cybersecurity threats, but this is not entirely true. Cloud providers have a shared responsibility model that outlines the division of responsibilities between the cloud provider and the user. Users are still responsible for certain aspects of security, such as web application security. Additionally, tools that were once effective at defending against cyber threats are no longer as effective in cloud environments. Cybercriminals are taking advantage of these vulnerabilities and are exploiting them using automated attacks. Therefore, it is important to use specific security and monitoring tools that take into account the details of cloud and container implementations.'
---

![homer_simpson_as_donald_trump](/static/images/cant-someone-else-do-it.jpeg)

> This article was originally posted at [ITI Blog](https://www.iti.es/blog/ciberseguridad-en-el-cloud-y-es-que-eso-no-puede-hacerlo-otro/) (in spanish)

> Don't miss the [webinar](https://www.youtube.com/watch?v=0Fw-J2dIGfE)_(in spanish)_
