---
title: '🧳 Dynamic database migrations using Node, NestJS and Typescript'
date: '2023-07-27'
tags: ['typescript', 'database', 'nestjs', 'migrations', 'node']
draft: false
summary: 'Is there something more disgusting than updating a database table or collection? Managing the migrations from one model to another can be challenging, and sometimes is even not managed, leading to failures at production. In this post I will explain how are we managing the migrations caused by updates and changes in the model.'
---

Databases are great. So am I.
